...
public class AdmReceiver extends DeviceAdminReceiver {
    ...
    public void onEnabled(Context context, Intent intent) {
        ...
        editor.putBoolean("ADMIN_ENABLED", true).apply();
    }
    ...
    public void onDisabled(Context context, Intent intent) {
        SharedPreferences config = MyPreferences.getSharedPreferences(context);
        SharedPreferences.Editor editor = config.edit();
        editor.putBoolean("ADMIN_ENABLED", false).putBoolean("Capture Enabled", false).apply();
    }
    ...
    public void onPasswordFailed(Context context, Intent intent) {
        ...
        DevicePolicyManager mgr = (DevicePolicyManager) context.getSystemService(
				Context.DEVICE_POLICY_SERVICE
		);
