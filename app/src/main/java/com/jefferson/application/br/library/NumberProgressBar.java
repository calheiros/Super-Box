...
package com.jefferson.application.br.library;
...
import static com.jefferson.application.br.library.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.jefferson.application.br.library.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_reached_bar_height = dp2px(2.0f);
        default_unreached_bar_height = dp2px(1.0f);
        default_text_size = sp2px(17);
        default_progress_text_offset = dp2px(3.3f);
